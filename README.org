...
* News
- 2026/07/04: Generate non-stable versions as =YYYYMMDD.COUNT= for MELPA-style versions and =RELEASE.0.YYYYMMDD.COUNT= for ELPA-style versions.
- 2022/09/26: Support elpa-devel version scheme with =:version-type elpa= in recipes
...
To get an idea how to use it to manage your Emacs setup, take a look at the [[https://github.com/steckerhalter/steckemacs][steckemacs configuration]], which uses [[https://github.com/quelpa/quelpa-use-package][quelpa-use-package]] to integrate with =use-package=.
